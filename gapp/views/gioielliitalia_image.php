<html>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-full">
                        <ul class="filters-adm">
                            <li class="filter-adm" name="gold" >Gold</li>
                            <li class="filter-adm" name="trauringe" >Trauringe</li>
                            <li class="filter-adm" name="einladungskarten">Einladungskarten</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-full">
                        <ul class="filters-adm">
                            <li class="filter-adm" name="modeschmuck-damen" >Modeschmuck-damen</li>
                            <li class="filter-adm" name="modeschmuck-herren" >Modeschmuck-herren</li>
                            <li class="filter-adm" name="taufkleider" >Taufkleider</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-full">
                        <ul class="filters-adm">
                            <li class="filter-adm" name="bomboniere-hochzeit" >Hochzeit</li>
                            <li class="filter-adm" name="bomboniere-komunion" >Komunion</li>
                            <li class="filter-adm" name="bomboniere-taufe_geburt" >Taufe Geburt</li>
                        </ul>
                    </div>
                </div>
        ...
        <script src="/assets/js/custom-image.js" type="text/javascript"></script>
